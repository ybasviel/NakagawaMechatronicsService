...
<svelte:head>
	<title>{data.work.title} - なかがわ電機サービス</title>
	<meta name="twitter:card" content={data.work.thumbnail ? 'summary_large_image' : 'summary'} />
	<meta property="og:url" content="https://nms.lnln.dev/works/{data.work.id}" />
